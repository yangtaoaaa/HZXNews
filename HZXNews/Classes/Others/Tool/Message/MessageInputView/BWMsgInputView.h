...
typedef enum
{
  BWMsgInputViewStyleDefault, // ios7 样式
  BWMsgInputViewStyleQuasiphysical
} BWMsgInputViewStyle;

@protocol BWMsgInputViewDelegate <NSObject>
...
@interface BWMsgInputView : UIImageView

@property (nonatomic,weak) id<BWMsgInputViewDelegate> delegate;
 ...
 *  当前输入工具条的样式
 */
@property (nonatomic, assign) BWMsgInputViewStyle messageInputViewStyle;
